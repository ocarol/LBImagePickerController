...
static CGFloat ZOOM_MAX = 2.0;
static CGFloat ZOOM_MIN = 1.0;
static CGFloat ZOOM_FACTOR = 2.0;
static CGFloat TAP_AREA_SIZE = 48.0f;

@interface LBPhotoPreviewCell()<UIScrollViewDelegate,UIGestureRecognizerDelegate>
/** 缩放scrollView */
...
@implementation LBPhotoPreviewCell
...
- (void)setModel:(LBPhotoPreviewModel *)model {
    _model = model;
